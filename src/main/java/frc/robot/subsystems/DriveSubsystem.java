...
public class DriveSubsystem extends SubsystemBase {
  ...
  // The gyro sensor (change to pidgion)
  private final Pigeon2 m_gyro = new Pigeon2(GyroConstants.GYRO_CAN_ID);
  private final Pigeon2Configuration gyro_config = new Pigeon2Configuration();
